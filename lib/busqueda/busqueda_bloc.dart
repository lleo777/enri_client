...
class BusquedaBloc extends Bloc<BusquedaEvent, BusquedaState> {
  ...
  Stream<BusquedaState> mapEventToState( BusquedaEvent event ) async* {
    ...
    if ( event is OnActivarBtnSolicitud ){
      yield state.copyWith( seleccionConductor: true);
    
    } else if ( event is OnDesactivarBtnSolicitud){
      yield state.copyWith( seleccionConductor: false);
    } 
